...
export type AnalyzePatientDocumentInput = z.infer<
  typeof AnalyzePatientDocumentInputSchema
>;
...
const AnalyzePatientDocumentOutputSchema = z.object({
  ...
  familyName: z
    .string()
    .optional()
    .describe("The patient's family name or surname."),
  ...
  dob: z
    .string()
    .optional()
    .describe("The patient's date of birth in YYYY-MM-DD format."),
  ...
  dateOfAdmission: z
    .string()
    .optional()
    .describe('The date of admission in YYYY-MM-DD format.'),
  attendingPhysician: z
    .string()
    .optional()
    .describe('The name of the attending physician.'),
  ...
  rashUlcers: z
    .string()
    .optional()
    .describe('Description of any rashes or ulcers.'),

  chiefComplaint: z
    .string()
    .optional()
    .describe("The patient's chief complaint or reason for visit."),
  pastMedicalHistory: z
    .string()
    .optional()
    .describe("Patient's past medical history."),
  pastSurgicalHistory: z
    .string()
    .optional()
    .describe("Patient's past surgical history."),
  medication: z
    .string()
    .optional()
    .describe('Patient\'s current or past medication.'),
  familyHistory: z
    .string()
    .optional()
    .describe("Patient's family medical history."),
});
export type AnalyzePatientDocumentOutput = z.infer<
  typeof AnalyzePatientDocumentOutputSchema
>;

export async function analyzePatientDocument(
  input: AnalyzePatientDocumentInput & ApiKeyInput
): Promise<AnalyzePatientDocumentOutput> {
